...
(b) Periodic unannounced inspection of the premises of such generators and the waste management activities thereon;

(c) Authorization of the containers in which such waste may be shipped, and a requirement that generators use only that type of container authorized by the state;

(d) Assurance that inspection of the carriers which transport such waste are conducted by proper authorities, and appropriate enforcement action taken for violations;
