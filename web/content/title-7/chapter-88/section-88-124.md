...
menu:
  hrs:
    identifier: HRS_0088-0124
    parent: HRS0088
    name: 88-124 Payment of state contributions to the system
weight: 42700
title: Payment of state contributions to the system
full_title: 88-124 Payment of state contributions to the system
---
**§88-124 Payment of state contributions to the system.** (a) The State shall pay to the various funds of the system the amounts payable by the State under this part. Payments shall be made:
