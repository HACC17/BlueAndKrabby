...
menu:
  hrs:
    identifier: HRS_0414-0111
    parent: HRS0414
    name: 414-111 Distributions to shareholders
weight: 24250
title: Distributions to shareholders
full_title: 414-111 Distributions to shareholders
---
D. Distributions

**[§414-111] Distributions to shareholders.** (a) A board of directors may authorize and the corporation may make distributions to its shareholders subject to restriction by the articles of incorporation and the limitation in subsection (c).
...
(A) The date the distribution is authorized if the payment occurs within one hundred twenty days after the date of authorization; or
