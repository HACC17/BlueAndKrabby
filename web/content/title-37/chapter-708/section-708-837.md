...
menu:
  hrs:
    identifier: HRS_0708-0837
    parent: HRS0708
    name: 708-837 Failure to return a rental motor vehicle; penalty
weight: 22245
title: Failure to return a rental motor vehicle; penalty
full_title: 708-837 Failure to return a rental motor vehicle; penalty
---
**[§708-837] Failure to return a rental motor vehicle; penalty.** [(1)] A person commits the offense of failure to return a rental motor vehicle when he intentionally does not return the motor vehicle to the person, or his agent, from whom the vehicle was rented within forty-eight hours after the time stated on the rental agreement, unless the person renting the vehicle gives notice that he will not be able to return the vehicle in the stated time and extends the time in which the vehicle will be returned.
