...
menu:
  hrs:
    identifier: HRS_0490-0002A-0405
    parent: HRS0490
...
---
**§490:2A-405 Excused performance.** Subject to section 490:2A-404 on substituted performance, the following rules apply:
...
(2) If the causes mentioned in paragraph (1) affect only part of the lessor's or the supplier's capacity to perform, the lessor or the supplier shall allocate production and deliveries among the lessor's or the supplier's customers but at the lessor's or the supplier's option may include regular customers not then under contract for sale or lease as well as the lessor's or supplier's own requirements for further manufacture. The lessor or supplier may so allocate in any manner that is fair and reasonable.

(3) The lessor seasonably shall notify the lessee and in the case of a finance lease the supplier seasonably shall notify the lessor and the lessee, if known, that there will be delay or nondelivery and, if allocation is required under paragraph (2), of the estimated quota thus made available for the lessee. [L 1991, c 40, pt of §1]