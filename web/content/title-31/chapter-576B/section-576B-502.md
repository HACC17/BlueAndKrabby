...
menu:
  hrs:
    identifier: HRS_0576B-0502
    parent: HRS0576B
    name: 576B-502 Employer's compliance with income withholding
weight: 95195
title: Employer's compliance with income withholding
full_title: 576B-502 Employer's compliance with income withholding
---
**§576B-502** **Employer's compliance with income withholding order of another state.** (a) Upon receipt of an income withholding order, the obligor's employer shall immediately provide a copy of the order to the obligor.
...
(c) Except as otherwise provided in subsection (d) and section 576B-503, the employer shall withhold and distribute the funds as directed in the withholding order by complying with the terms of the order that specify:
...
(3) The times within which the employer must implement the withholding order and forward the child support payment. [L 1997, c 295, pt of §1; am L 2015, c 77, pt of §1]