...
menu:
  hrs:
    identifier: HRS_0428-0406
    parent: HRS0428
    name: 428-406 Limitations on distributions
weight: 50165
title: Limitations on distributions
full_title: 428-406 Limitations on distributions
---
...
(A) Distribution is authorized if the payment occurs within one hundred twenty days after the date of authorization; or

(B) Payment is made if it occurs more than one hundred twenty days after the date of authorization.
...
(e) Indebtedness of a limited liability company, including indebtedness issued in connection with or as part of a distribution, is not considered a liability for purposes of determinations under subsection (a) if its terms provide that payment of principal and interest is made only if and to the extent that payment of a distribution to members could then be made under this section. If the indebtedness is issued as a distribution, each payment of principal or interest on the indebtedness is treated as a distribution, the effect of which is measured on the date the payment is made. [L 1996, c 92, pt of §1]